...
export class ShiftsService {
  ...
  startShift(startTime: number, type: 'working' | 'traveling' | 'other' | 'lunch', workingPlace: string, details: string, geolocation: any, afAuthToken: string | null) {
  ...
  closeShift(closingTime: string, endGeolocation: any, afAuthToken: any) {
